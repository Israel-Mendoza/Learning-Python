...
Just as we did before, we will delegate the base class
"Sequence" to handle the implementation of the count() method.
The Sequence class already provides the .count() method,
