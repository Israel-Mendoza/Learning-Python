...
print(fn.__code__.co_freevars)  # A tuple with the names of the free variables:
# ('x', 'y')
print(fn.__closure__)  # A tuple containing the cell objects (the free variables):
# (<cell at 0x000001C768CB2FD0: str object at 0x000001C768C59DF0>, <cell at 0x000001C768CB2FA0: str object at 0x000001C768C668F0>)
...
# inner
print(fn.__code__.co_varnames)  # Tuple with the names of the variables in the closure
# ()
